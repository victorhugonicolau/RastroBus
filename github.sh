...
export repositorio="https://github.com/victorhugonicolau/RastroBus.git";
...
git commit -am "RastroBus - Montando o layout da minha tela (mapa + itens em baixo) - criação do rotas previstas.item  - $(date)"
